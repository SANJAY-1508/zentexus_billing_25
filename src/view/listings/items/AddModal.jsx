...
//                 value="product"
//                 variant={
//                   itemType === "product" ? "primary" : "outline-secondary"
//                 }
...
//                 value="service"
//                 variant={
//                   itemType === "service" ? "primary" : "outline-secondary"
//                 }
...
//           <Col md={3}>
//             <Form.Control className="white-input" placeholder="Item Name *" />
//           </Col>
//           <Col md={3}>
//             <Form.Control className="white-input" placeholder="Item HSN" />
//           </Col>
//           <Col md={2}>
//             <Button variant="light" className="w-100 text-primary" style={{backgroundColor: "#cce7f3"}}>
//               Select Unit
//             </Button>
//           </Col>
//           <Col md={3}>
...
//             <Form.Control placeholder="Item Code" className="white-input" />
//             <Button
//               variant="light"
//               size="sm"
//               className="position-absolute end-0 top-0 me-1 m-1 text-primary border p-1"  style={{backgroundColor: "#cce7f3"}}
//             >
//               Assign Code
//             </Button>
//           </Col>
...
//                 style={{
//                   color:
//                     activePricingTab === "pricing" ? "#dc3545" : "#6c757d",
//                 }}
//               >
//                 Pricing
//               </span>
...
function AddModal({ show, onHide, activeTab = "PRODUCT" }) {
