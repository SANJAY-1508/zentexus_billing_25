...
//   // FIXED: Changed from state.estimates to state.estimate
//   // const { parties, partiesStatus, estimates } = useSelector((state) => state.estimate);
//   const { parties = [], partiesStatus = "idle", estimates = [] } = useSelector((state) => state.estimate || {});
